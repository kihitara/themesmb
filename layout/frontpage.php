...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="theme/themesmb/style/contentslider.css" />
    <script type="text/javascript" src="theme/themesmb/javascript/contentslider.js">
    <!--
    /***********************************************
    ...
    <div id="page-content">
			...
			<div id="contentslider" class="clearfix">
			    ...
			    featuredcontentslider.init({
				    ...
				    contentsource: ["ajax", "theme/themesmb/slidercontent/content.htm"],  //Valid values: ["inline", ""] or ["ajax", "path_to_file"]
				    toc: ["<img src='theme/themesmb/pix/1.png' />", "<img src='theme/themesmb/pix/2.png' />", "<img src='theme/themesmb/pix/3.png' />", "<img src='theme/themesmb/pix/4.png' />", "<img src='theme/themesmb/pix/5.png' />", "<img src='theme/themesmb/pix/6.png' />", "<img src='theme/themesmb/pix/7.png' />", "<img src='theme/themesmb/pix/8.png' />", "<img src='theme/themesmb/pix/9.png' />"],  //Valid values: "#increment", "markup", ["label1", "label2", etc]
				    nextprev: ["<img src='theme/themesmb/pix/left.png' />", "<img src='theme/themesmb/pix/right.png' />"],  //labels for "prev" and "next" links. Set to "" to hide.
