...
$plugin->version   = 2012052001; // The current module version (Date: YYYYMMDDXX)
...
$plugin->release = '1.0 (Build: 2012052001)';
$plugin->component = 'theme_themesmb'; // Full name of the plugin (used for diagnostics)